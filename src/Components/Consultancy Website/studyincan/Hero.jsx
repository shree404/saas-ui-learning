    ...
    return(
       ...
       <div className="flex justify-between gap-30" >
         <div className="flex mt-8"> <br /><br />
           <p className="text-white text-xl ml-20">Affordable Tuition Fees I Post Graduation Work Visa I Employment Opportunity</p> <br /> <br />
           <br /><br /><br />
         </div>
